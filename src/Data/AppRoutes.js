...
export const AppRoutes = {
    ...
    "customer_view": { path: "/customer/view/id", component: <Customer type="view" /> },
    "customer_edit": { path: "/customer/edit/id", component: <Customer type="edit" /> },
    ...
    "vendor_item_add": { path: "/vendor/item/add", component: (<></>) },
